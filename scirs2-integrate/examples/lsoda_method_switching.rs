    ...
    match result {
        Ok(res) => {
            ...
            for i in 0..res.t.len() {
                ...
                writeln!(&mut file, "{:.6} {:.10e} {:.10e} {:.10e} {:.6e}", 
                         t, y1, y2, y3, k2).unwrap();
            ...
            println!("LSODA should use BDF method in the stiff regions and may switch back to Adams");
        },
        Err(e) => {
            println!("Integration failed: {}", e);
        }
