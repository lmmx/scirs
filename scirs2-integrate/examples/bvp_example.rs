...
fn main() {
    ...
    match solve_bvp(fun, bc, Some(x.clone()), y_init, None) {
        Ok(result) => {
            ...
            println!("{:>10} {:>15} {:>15} {:>15}", "x", "y_numerical", "y_exact", "error");
            println!("{:->10} {:->15} {:->15} {:->15}", "", "", "", "");
            ...
            for i in 0..result.x.len() {
                ...
                println!("{:10.6} {:15.6} {:15.6} {:15.6e}", x_val, y_val, sin_val, error);
            }
            ...
            match solve_bvp(fun2, bc2, Some(x), y_init2, None) {
                Ok(result2) => {
                    ...
                    for i in 0..result2.x.len() {
                        ...
                        println!("{:10.6} {:15.6} {:15.6} {:15.6e}", x_val, y_val, cos_val, error);
                    }
