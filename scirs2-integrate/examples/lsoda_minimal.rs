...
fn main() {
    ...
    println!("Parameters: initial_step={}, min_step={}", initial_step, min_step);
    ...
    match result {
        Ok(res) => {
            ...
            println!("Final value: {}, Exact: {}", res.y.last().unwrap()[0], (-1.0f64).exp());
            println!("Error: {:.2e}", (res.y.last().unwrap()[0] - (-1.0f64).exp()).abs());
        ...
        Err(e) => {
            ...
            println!("DOP853 Steps: {}, Function evaluations: {}", 
                     dop_result.n_steps, dop_result.n_eval);
            println!("Final value: {}, Exact: {}", 
                     dop_result.y.last().unwrap()[0], (-1.0f64).exp());
            println!("Error: {:.2e}", 
