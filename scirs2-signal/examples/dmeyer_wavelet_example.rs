...
fn main() {
    ...
    for (wavelet, name) in wavelets {
        ...
        println!("{} coefficient lengths: cA3={}, cD3={}, cD2={}, cD1={}", 
                name, approx.len(), detail3.len(), detail2.len(), detail1.len());
        ...
        // Store metrics
        computation_times.push((name, decomp_time.as_micros() as f64 / 1000.0, recon_time.as_micros() as f64 / 1000.0));
    ...
    println!("{:<15} {:>12} {:>12}", "Wavelet", "Decomp Time", "Recon Time");
    println!("{:-<15} {:->12} {:->12}", "", "", "");
    ...
    let layout = Layout::new()
        .title("Meyer vs. DMeyer Wavelet Denoising Comparison");
    ...
    let coeffs_layout = Layout::new()
        .title("Meyer vs. DMeyer Level 1 Detail Coefficients");
