...
fn main() {
    ...
    println!("Coefficient lengths: cA3={}, cD3={}, cD2={}, cD1={}", 
             approx.len(), detail3.len(), detail2.len(), detail1.len());
    ...
    let coeffs_layout = plotly::Layout::new()
        .title("Meyer Wavelet Coefficients");
...
fn compare_wavelets(signal: &[f64], noisy_signal: &[f64], t: &[f64]) {
    ...
    let comp_layout = plotly::Layout::new()
        .title("Wavelet Family Comparison for Denoising");
