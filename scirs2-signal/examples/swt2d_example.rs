...
use scirs2_signal::swt2d::{swt2d, swt2d_decompose, swt2d_reconstruct, iswt2d};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\nMaximum multi-level reconstruction error: {:.6e}", max_multi_error);
    ...
    println!("  Improvement: {:.1}%", 100.0 * (mse_noisy - mse_denoised) / mse_noisy);
